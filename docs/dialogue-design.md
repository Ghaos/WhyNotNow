...
ローカルのブラウザ受信トレイは保存済み項目を見直すための正規のレビュー面であり、Codex は記録、解釈、調査、編集、開始、アーカイブのためのワークベンチです。両者の責務、共有するデータ正本、代替導線の詳細は、[AI と GUI の境界](interaction-boundary.md)で定義します。この文書ではCodex側の対話ポリシーを扱います。
